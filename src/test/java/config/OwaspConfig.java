...
public class OwaspConfig {
    ...
    public static String host=ReadConfig.getInstance().getOwaspHost();
    ...
    public static final String READ_ALERTS=protocol+host+":"+port+"/HTML/alert/view/alerts/?baseurl=";
    public static final String READ_LIST_ATTACK=protocol+host+":"+port+"/HTML/ascan/view/scanProgress/?scanId=";
